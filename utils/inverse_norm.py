...
def inverse_norm(input_vec, task_id):
    ...
    for b in range(batch_size):
        ...
        if tid == 1: # 5t正推，输入应该为5t电路的target
            output_vec[b][0] = output_vec[b][0] * (10602059.8211294 - 645632.611780252) + 645632.611780252
            output_vec[b][1] = output_vec[b][1] * (292.707702161998 - 0.020728808400004) + 0.020728808400004
            output_vec[b][2] = output_vec[b][2] * (100000000000 - 1221065.9825421) + 1221065.9825421
            output_vec[b][3] = output_vec[b][3] * (149.258357674875 + 12.2475159224187) - 12.2475159224187
            output_vec[b][4] = output_vec[b][4] * (1416090.54834304 - 1.03019875662727) + 1.03019875662727
        elif tid == 2: # two_stage正推，输入应该为two_stage电路的target
            output_vec[b][0] = output_vec[b][0] * (262299959.900606 - 0) + 0
            output_vec[b][1] = output_vec[b][1] * (41554.1940092721 - 0.006677072180007) + 0.006677072180007
            output_vec[b][2] = output_vec[b][2] * (123495303.754714 - 3791.34972457912) + 3791.34972457912
            output_vec[b][3] = output_vec[b][3] * (179.989617050718 + 179.579391753632) - 179.579391753632
